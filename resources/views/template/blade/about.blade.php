            ...
            <form action="{{ route('sections.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card col">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input id="excerpt" type="text" class="form-control" name="excerpt" autocomplete="excerpt" autofocus>
                        @error('excerpt')
                            <span class="text-danger small" role="alert">
                                {{ $message }}
                            </span>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input id="button_text" type="text" class="form-control" name="button_text" autocomplete="button_text" autofocus>
                        @error('button_text')
                            <span class="text-danger small" role="alert">
                                {{ $message }}
                            </span>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input id="button_link" type="text" class="form-control" name="button_link" autocomplete="button_link" autofocus>
                        @error('button_link')
                            <span class="text-danger small" role="alert">
                                {{ $message }}
                            </span>
