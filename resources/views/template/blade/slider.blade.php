                ...
                <form action="{{ route('sections.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card col">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="title_h4" type="text" class="form-control" name="title_h4" placeholder="Input Title (h4)" value="{{ old('title_h4') }}">
                            @error('title_h4')
                                <span class="text-danger small" role="alert">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="title_h1" type="text" class="form-control" name="title_h1" placeholder="Input Title (h1)" value="{{ old('title_h1') }}">
                            @error('title_h1')
                                <span class="text-danger small" role="alert">
                                    {{ $message }}
                                </span>
