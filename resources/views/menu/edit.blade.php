                        ...
                        <div class="card col">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input id="name" type="name" class="form-control" name="name" required
                                    autocomplete="name" value="{{ $menus->name }}">
                                @error('name')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input id="link" type="text" class="form-control" name="link" required
                                    autocomplete="link" value="{{ $menus->link }}">
                                @error('link')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input id="parent" type="number" class="form-control" name="parent" required
                                    autocomplete="parent" value="{{ $menus->parent }}">
                                @error('parent')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input id="index" type="number" class="form-control" name="index" required
                                    autocomplete="index" value="{{ $menus->index }}">
                                @error('index')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
